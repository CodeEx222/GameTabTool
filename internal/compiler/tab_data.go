...
//}
//
//func LoadDataTable(filegetter helper.FileGetter, fileName, headerType,
//	resolveHeaderType string, typeTab *model.TypeTable) (ret []*model.DataTable, err error) {
...
//	}
//	if !IsLoadSheet {
//		panic(fmt.Sprintf("%s has no sheet1", fileName))
//	}
//
//	return
//}
